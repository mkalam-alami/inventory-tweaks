...
public class Const {
    ...
    public static final String MOD_VERSION = "1.23 (1.7.3)";
    public static final String PAGE_SUFFIX = "123";
    ...
    public static final String OLD_CONFIG_RULES_FILE = MINECRAFT_DIR + "InvTweaksConfig.txt";
    ...
    public static final String HELP_URL = "http://wan.ka.free.fr/?invtweaks"+PAGE_SUFFIX;
