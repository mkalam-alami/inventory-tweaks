 ...
 *
 */
public class SortableContainerOld extends Obfuscation {
    ...
    public SortableContainerOld(Minecraft mc, InvTweaksConfig config, Container container, boolean inventoryPart) {
        super(mc);
