...
public class InvTweaksGuiSettings extends InvTweaksGuiSettingsAbstract {
    ...
    public InvTweaksGuiSettings(Minecraft mc, asw parentScreen, InvTweaksConfig config) {
    ...
    public void A_() { /* initGui */
        ...
        controlList.add(new arl(ID_EDITRULES, p.getX() + 55, obf.getWindowHeight(this) / 6 + 96, InvTweaksLocalization.get("invtweaks.settings.rulesfile")));
        controlList.add(new arl(ID_EDITTREE, p.getX() + 55, obf.getWindowHeight(this) / 6 + 120, InvTweaksLocalization.get("invtweaks.settings.treefile")));
        controlList.add(new arl(ID_HELP, p.getX() + 55, obf.getWindowHeight(this) / 6 + 144, InvTweaksLocalization.get("invtweaks.settings.onlinehelp")));
        ...
        if (!Desktop.isDesktopSupported()) {
            for (Object o : controlList) {
            	if (obf.isGuiButton(o)) {
            	    arl guiButton = obf.asGuiButton(o);
