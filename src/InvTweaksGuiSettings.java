...
public class InvTweaksGuiSettings extends InvTweaksGuiSettingsAbstract {
    ...
    public void A_() { /* initGui */
        ...
        controlList.add(new ark(ID_EDITRULES, p.getX() + 55, obf.getWindowHeight(this) / 6 + 96, InvTweaksLocalization.get("invtweaks.settings.rulesfile")));
        controlList.add(new ark(ID_EDITTREE, p.getX() + 55, obf.getWindowHeight(this) / 6 + 120, InvTweaksLocalization.get("invtweaks.settings.treefile")));
        controlList.add(new ark(ID_HELP, p.getX() + 55, obf.getWindowHeight(this) / 6 + 144, InvTweaksLocalization.get("invtweaks.settings.onlinehelp")));
        ...
        if (!Desktop.isDesktopSupported()) {
            for (Object o : controlList) {
            	if (obf.isGuiButton(o)) {
            	    ark guiButton = obf.asGuiButton(o);
