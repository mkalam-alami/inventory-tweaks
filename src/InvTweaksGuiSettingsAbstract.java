 ...
 * 
 */
public abstract class InvTweaksGuiSettingsAbstract extends vp /* GuiScreen */ {
    ...
    public void c() { /* initGui */
        ...
        controlList.add(new abp(ID_DONE, p.getX() + 55, obf.getHeight(this) / 6 + 168, LABEL_DONE));
    ...
    protected void toggleBooleanButton(abp guibutton, String property, String label) {
