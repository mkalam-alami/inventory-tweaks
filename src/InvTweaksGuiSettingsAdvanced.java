...
public class InvTweaksGuiSettingsAdvanced extends InvTweaksGuiSettingsAbstract {
    ...
    public InvTweaksGuiSettingsAdvanced(Minecraft mc, apn parentScreen, InvTweaksConfig config) {
    ...
    public void w_() { /* initGui */
        ...
        controlList.add(new aoh(ID_EDITSHORTCUTS, p.getX() + 55, obf.getWindowHeight(this) / 6 + 144, InvTweaksLocalization.get("invtweaks.settings.advanced.mappingsfile")));
