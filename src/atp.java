...
/*     */ 
/*     */ 
/*     */ public abstract class atp extends asv
/*     */ {
/*  19 */   protected static baf a = new baf();
...
/*  66 */     int k = 240;
/*  67 */     int i1 = 240;
/*  68 */     bde.a(bde.b, k / 1.0F, i1 / 1.0F);
/*  69 */     GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
/*     */     Object localObject;
/*  72 */     for (k = 0; k < this.d.b.size(); k++) {
/*  73 */       localObject = (ry)this.d.b.get(k);
/*     */ 
/*  75 */       a((ry)localObject);
/*     */ 
/*  77 */       if (a((ry)localObject, paramInt1, paramInt2)) {
/*  78 */         this.o = ((ry)localObject);
/*     */ 
/*  80 */         GL11.glDisable(2896);
/*  81 */         GL11.glDisable(2929);
/*     */ 
/*  83 */         int i2 = ((ry)localObject).h;
/*  84 */         int i3 = ((ry)localObject).i;
...
/*     */ 
/*  93 */     qe localqe = this.e.g.bJ;
/*  94 */     if (localqe.n() != null) {
/*  95 */       GL11.glTranslatef(0.0F, 0.0F, 32.0F);
/*  96 */       this.j = 200.0F;
/*  97 */       a.f = 200.0F;
/*     */ 
/*  99 */       a.b(this.k, this.e.o, localqe.n(), paramInt1 - i - 8, paramInt2 - j - 8);
/* 100 */       a.c(this.k, this.e.o, localqe.n(), paramInt1 - i - 8, paramInt2 - j - 8);
/* 101 */       this.j = 0.0F;
/* 102 */       a.f = 0.0F;
/*     */     }
/*     */ 
/* 105 */     if ((localqe.n() == null) && (this.o != null) && (this.o.d())) {
/* 106 */       localObject = this.o.c();
/* 107 */       a((tu)localObject, paramInt1 - i, paramInt2 - j);
/*     */     }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   protected void a(tu paramtu, int paramInt1, int paramInt2) {
/* 118 */     GL11.glDisable(32826);
/* 119 */     aqi.a();
/* 120 */     GL11.glDisable(2896);
/* 121 */     GL11.glDisable(2929);
/*     */ 
/* 123 */     List<?> localList = paramtu.a(this.e.g, this.e.y.x);
...
/*     */ 
/* 163 */         if (i6 == 0)
/* 164 */           str2 = "§" + Integer.toHexString(paramtu.u().e) + str2;
/*     */         else {
/* 166 */           str2 = "§7" + str2;
/*     */         }
/*     */ 
...
/*     */ 
/*     */   private void a(ry paramry) {
/* 226 */     int i = paramry.h;
/* 227 */     int j = paramry.i;
/* 228 */     tu localtu = paramry.c();
/*     */ 
/* 230 */     int k = 0;
/*     */ 
/* 232 */     this.j = 100.0F;
...
/* 247 */       a.b(this.k, this.e.o, localtu, i, j);
/* 248 */       a.c(this.k, this.e.o, localtu, i, j);
/*     */     }
/* 250 */     a.f = 0.0F;
/* 251 */     this.j = 0.0F;
/*     */   }
/*     */ 
/*     */   private ry c(int paramInt1, int paramInt2) {
/* 255 */     for (int i = 0; i < this.d.b.size(); i++) {
/* 256 */       ry localry = (ry)this.d.b.get(i);
/* 257 */       if (a(localry, paramInt1, paramInt2)) return localry;
/*     */     }
/* 259 */     return null;
/*     */   }
/*     */ 
...
/* 268 */       ry localry = c(paramInt1, paramInt2);
/*     */ 
/* 270 */       int j = this.m;
/* 271 */       int k = this.n;
...
/*     */ 
/* 274 */       int i2 = -1;
/* 275 */       if (localry != null) i2 = localry.g;
/*     */ 
/* 277 */       if (i1 != 0) {
/* 278 */         i2 = -999;
/*     */       }
...
/* 281 */       if (i2 != -1)
/* 282 */         if (i != 0) {
/* 283 */           a(localry, i2, paramInt3, 3);
/*     */         } else {
/* 285 */           int i3 = (i2 != -999) && ((Keyboard.isKeyDown(42)) || (Keyboard.isKeyDown(54))) ? 1 : 0;
/* 286 */           a(localry, i2, paramInt3, i3 != 0 ? 1 : 0);
/*     */         }
/*     */     }
/*     */   }
/*     */ 
/*     */   private boolean a(ry paramry, int paramInt1, int paramInt2)
/*     */   {
/* 293 */     return c(paramry.h, paramry.i, 16, 16, paramInt1, paramInt2);
/*     */   }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   protected void a(ry paramry, int paramInt1, int paramInt2, int paramInt3) {
/* 306 */     if (paramry != null) paramInt1 = paramry.g;
...
/*     */   {
/* 324 */     if ((this.e.g.bJ.n() == null) && (this.o != null)) {
