...
import invtweaks.VanillaSlotMaps;
...
public class ContainerTransformer implements IClassTransformer {
    ...
    public ContainerTransformer() {
        ...
        standardClasses.put("net.minecraft.inventory.ContainerRepair", new ContainerInfo(true, true, false, getVanillaSlotMapInfo("containerPlayerSlots")));
        ...
        standardClasses.put("net.minecraft.inventory.ContainerEnchantment", new ContainerInfo(true, true, false, getVanillaSlotMapInfo("containerEnchantmentSlots")));
        ...
        // Chest-type
        standardClasses.put("net.minecraft.inventory.ContainerDispenser", new ContainerInfo(false, false, true, (short)3, getVanillaSlotMapInfo("containerChestDispenserSlots")));
    ...
    public static void transformContainer(ClassNode clazz, ContainerInfo info) {
        ...
        if(info.slotMapMethod.isStatic) {
            generateForwardingToStaticMethod(clazz, "invtweaks$slotMap", info.slotMapMethod.methodName, info.slotMapMethod.methodType.getReturnType(), info.slotMapMethod.methodClass, info.slotMapMethod.methodType.getArgumentTypes()[0]);
        } else {
            generateSelfForwardingMethod(clazz, "invtweaks$slotMap", info.slotMapMethod.methodName, info.slotMapMethod.methodType);
        }
    }
    ...
    public static void transformBaseContainer(ClassNode clazz) {
        ...
        generateForwardingToStaticMethod(clazz, "invtweaks$slotMap", "unknownContainerSlots", Type.getObjectType("java/util/Map"), Type.getObjectType("invtweaks/VanillaSlotMaps"));
    }
